(function(b) {
    ...
    a.define('/gif.worker.coffee', function(d, e, f, g) {
        ...
        c = function(a) {
            var c, e, d, f;
            return c = new b(a.width,a.height),
            ...
            .call(this, []),
            self.postMessage(a, f)) : self.postMessage(a)
        }
        ,
    ...
    a.define('/GIFEncoder.js', function(e, h, i, j) {
        ...
        b.prototype.writeShort = function(a) {
            this.out.writeByte(a & 255),
            this.out.writeByte(a >> 8 & 255)
        }
        ,
        ...
        function f(y, D, C, B) {
            ...
            function l(a, c) {
                ...
                while (e >= 8)
                    ...
                    g >>= 8,
                    e -= 8;
                if ((k > m || j) && (j ? (m = p(n_bits = q),
                j = !1) : (++n_bits,
                n_bits == b ? m = 1 << b : m = p(n_bits))),
                a == o) {
                    while (e > 0)
                        w(g & 255, c),
                        g >>= 8,
            ...
            var s = Math.max(2, B), r = new Uint8Array(256), h = new Int32Array(a), n = new Int32Array(a), g, e = 0, f, k = 0, m, j = !1, q, i, o;
            this.encode = z
        }
        var c = -1
          , b = 12
    ...
    a.define('/TypedNeuQuant.js', function(A, F, E, D) {
        function C(A, B) {
            ...
            function L(j, e, n, l, k) {
                var h = Math.abs(e - j), i = Math.min(e + j, a), g = e + 1, f = e - 1, m = 1, b, d;
                while (g < i || f > h)
                    d = z[m++],
                    g < i && (b = o[g++],
                    b[0] -= d * (b[0] - n) / c,
            ...
            function C(p, s, q) {
                var h = 2147483647, k = h, d = -1, m = d, c, j, e, n, l;
                for (c = 0; c < a; c++)
                    j = o[c],
            ...
            function E(j, i, k) {
                var b, d, c, e = 1e3, h = -1, f = q[i], g = f - 1;
                while (f < a || g >= 0)
                    f < a && (d = o[f],
                    c = d[1] - i,
                    c >= e ? f = a : (f++,
            ...
            function F() {
                var c, f = A.length, D = 30 + (B - 1) / 3, y = f / (3 * B), q = ~~(y / w), n = d, o = u, a = o >> h;
                for (a <= 1 && (a = 0),
                c = 0; c < a; c++)
                    z[c] = n * ((a * a - c * c) * m / (a * a));
                var i;
                f < s ? (B = 1,
                i = 3) : f % l !== 0 ? i = 3 * l : f % k !== 0 ? i = 3 * k : f % p !== 0 ? i = 3 * p : i = 3 * j;
                var r, t, x, e, g = 0;
                c = 0;
                while (c < y)
                    if (r = (A[g] & 255) << b,
